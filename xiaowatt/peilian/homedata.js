...
/* 六维（与陪练舱报告同名同序） */
const DIMS6 = ['规程记忆', '唱票复诵', '设备状态核对', '异常处置', '调度术语', '风险辨识'];
const RADAR_NOW  = [86, 90, 62, 74, 71, 83];
const RADAR_PREV = [80, 84, 55, 60, 66, 79];
...
/* 知识课堂：推荐课程与学时回写记录 */
const COURSES = [
  { n: 'GIS 设备结构与四项位置指示核对', h: 4, tag: '设备状态核对' },
  { n: '调度规范用语与接发令要点', h: 2, tag: '调度术语' },
  { n: '倒闸操作典型异常处置案例', h: 3, tag: '异常处置' },
  { n: '电气操作票填写与三审要求', h: 2, tag: '规程记忆' }
];
const HOUR_LOG = [
...
const COACHES = [
  { id: 'daozha', n: '倒闸操作 · 陈志远', fam: '变电运行', dom: '倒闸操作', open: true, lvl: 3, min: 45, users: 238, gain: 11, tags: ['唱票复诵', '设备状态核对', '调度术语'], desc: '110kV 线路运行转检修全流程对练：接令、唱票复诵、手指口述、执行核对、检查回报，含票令核对与异常处置支线。' },
  ...
  { id: 'fire',   n: '消防应急处置', fam: '安全监督', dom: '应急', open: false, lvl: 2, min: 20, users: 167, gain: 8,  tags: ['应急处置'], desc: '设备着火、人员触电急救的分秒推演，处置顺序错误即时打断。' },
...
const RECO = [
  ...
  { coach: 'term',   pre: null,     why: '「调度术语」低于班组均值 7 分', act: '查看教练' },
