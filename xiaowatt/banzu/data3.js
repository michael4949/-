...
/* 岗位说明书：各岗位应持资质、应达技能等级、能力图谱底线（配网资产部 2026 版岗位说明书） */
const POST_REQ = {
...
/* 班组按作业需要的持证人数下限（班长与配网资产部 2026-07 定；岗位胜任能力证按评价标准"所有在岗人员（新员工除外）均须取得"） */
...
const OUTPUT3 = [
  { n: '孙志远', d: '2024-03', kind: '晋升', to: '配网资产部 技术专责' }, { n: '罗海', d: '2024-11', kind: '输出', to: '试验班 副班长' }, { n: '韩雪', d: '2025-06', kind: '跨班锻炼', to: '配电运维一班 三个月' }, { n: '吴倩', d: '2026-02', kind: '跨班锻炼', to: '试验班 两周（电缆试验）' }
];
/* 指标模型确认记录（三上三下，虚拟人物） */
const CONFIRM_LOG = [
  { d: '2026-07-15', who: '赵立群 · 配电自动化班 班长', what: '第一轮：五类指标、阈值、来源逐条过一遍，改了工作量公平的阈值（每周 24 小时）' },
  { d: '2026-07-22', who: '陈国安 · 配网资产部 主管', what: '第二轮：确认能力覆盖按作业授权认证表取数（原九类核心技能迁移到对应模块），人均实操量按星级评价口径' },
