...
XW.ask = function (text, voice) {
  ...
  if (role() === 'manager') {
    ...
    if (/工时|均衡/.test(t)) { go(() => XW.answer('工时最不均衡的是试验班：张伟本周 28 小时、刘畅借在配电运维一班，班长周建国自己 10 小时；配电自动化班黄伟强 26 小时，超班组约定的每周 24 小时。', null, { confirm: false, chart: CH.mini.bars([{ n: '张伟', v: 28, c: '#e5484d', tip: '试验班' }, { n: '黄伟强', v: 26, c: '#e5484d', tip: '配电自动化班' }, { n: '李文博', v: 24, c: CPAL[0] }, { n: '刘畅', v: 22, c: CPAL[0], tip: '试验班 · 借在配电运维一班' }], { limit: WEEK_LIMIT, unit: 'h', max: 32, h: 13 }) })); return; }
    ...
    if (/风险|态势|哪个班/.test(t)) { go(() => ensure('super', () => XW.answer('这周三个班组的风险：配电自动化班 华发民公用柜缺陷超期、黄伟强本周外勤超 24 小时；试验班 张伟 28 小时、刘畅借出后电缆证只剩 2 人；配电运维一班 证书到期 2 人。分层不排名，点热力格看明细。', null, { confirm: false }))); return; }
