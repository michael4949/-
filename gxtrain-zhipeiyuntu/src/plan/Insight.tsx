  ...
  return (
    <div className="h-full flex flex-col gap-3 p-3 min-h-0">
      <div className="grid grid-cols-5 gap-3 shrink-0">
        ...
        <Kpi k="已采纳建议" v={`${applied.length} / ${SUGGESTIONS.length}`} d="点击右侧建议卡采纳" />
      </div>
