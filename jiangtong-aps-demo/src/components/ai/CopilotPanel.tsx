...
// §11.1 Copilot 全局组件外壳（Sprint 0 仅做外壳；Sprint 2/3 填充 Agent 行为）
      ...
      {!open && (
        <button
          ...
          className="fixed right-6 bottom-6 z-[9999] h-12 px-4 rounded-full
                     ...
                     shadow-[0_10px_30px_rgba(124,58,237,0.4)] hover:shadow-[0_14px_40px_rgba(124,58,237,0.5)]
      ...
      >
        ...
        <div className="h-14 px-4 flex items-center gap-3 border-b border-line">
          ...
          <button
            ...
            className="ml-auto w-8 h-8 rounded-lg hover:bg-line/40 flex items-center justify-center text-ink-dim"
            title="关闭"
          >
            <X size={16} />
          </button>
        ...
        {/* 消息区（Sprint 0 占位） */}
        <div className="h-[calc(100vh-14rem)] overflow-y-auto px-4 py-4 space-y-3">
          <div className="text-[12.5px] text-ink-dim leading-7 border border-dashed border-line rounded-lg px-4 py-3">
            您好，我是排产助手 ✨ <br />
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-line p-3 bg-card">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 h-9 px-3 rounded-lg bg-bg border border-line text-[12.5px]
